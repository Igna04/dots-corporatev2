...
module.exports = {
	async apply(value, previousValues) {
		return new Promise(resolve => {
			console.log('\n');
			console.log(
				'TheCodingMachine React-Native mobile_app_corporate initialized with success ! 🚀\n'
			);
			console.log(
				`${green(
					'                                                                    .-`    `::  \n' +
			...
			console.log(
				'- 📚 If you need to read more about this mobile_app_corporate : https://thecodingmachine.github.io/react-native-mobile_app_corporate/'
			);
			console.log(
				'- 🤕 If you have some troubles : https://github.com/thecodingmachine/react-native-mobile_app_corporate/issues'
			);
			console.log(
				'- ⭐ If you love this mobile_app_corporate, give us a star, you will be a ray of sunshine in our lives :) https://github.com/thecodingmachine/react-native-mobile_app_corporate'
			);
