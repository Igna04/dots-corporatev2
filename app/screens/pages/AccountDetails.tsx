...
import { RootStackParamList } from 'app/screens/pages/navigationTypes'; // Adjust the path as needed
...
export const AccountDetails: React.FC = () => {
    ...
    const { name = 'No Name', accountNumber = 'No Account Number' } = route.params || {};
        ...
        <Screen preset="scroll" contentContainerStyle={styles.scrollContainer} safeAreaEdges={["top"]}>
            ...
            <View style={styles.container}>
                <View style={styles.qrContainer}>
                    <QRCode
                        value={base64Data} // Use base64Data for QR code value
